...
<label>Awards</label>
    <?= Html::activeCheckboxList($model, 'bestff_array', \yii\helpers\ArrayHelper::map($rewards, 'id', 'title')) ?>

    <label>Awards National</label>
    <?= Html::activeCheckboxList($model, 'bestffn_array', \yii\helpers\ArrayHelper::map($rewards, 'id', 'title')) ?>
